import {
  ...
  const client = new BlinksightsClient('gEb7nD9yLkau1P4uyMdke9byJNrat61suH4vYiPUuiR');
  ...
  export const GET = async (req: Request) => {
    try {
      ...
      const paytype = orgDetails.feesType === "sol"? "SOL":"BARK":"USDC";
      ...
      const payload = await client.createActionGetResponseV1(req.url, {
        ...
        description: `Subscribe to ${orgDetails.name} for Updates, Alphas, NFT membership, Newsletters and exclusive content.
